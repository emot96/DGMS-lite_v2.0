...
class LoginUpsAsset(models.Model):
    # Field name made lowercase.
    device_id = models.OneToOneField(
        'LoginUserDetail', models.DO_NOTHING, db_column='Device_ID_id', primary_key=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    battery_rating = models.CharField(
        db_column='Battery_Rating', max_length=200)
    # Field name made lowercase.
    number_of_batteries = models.BigIntegerField(
        db_column='Number_of_batteries')
    # Field name made lowercase.
    ...
    ups_warranty_start_date = models.DateField(
        db_column='UPS_Warranty_Start_Date')
    # Field name made lowercase.
    ups_warranty_end_date = models.DateField(db_column='UPS_Warranty_End_Date')
    # Field name made lowercase.
    ups_warranty_period = models.CharField(
        db_column='UPS_Warranty_Period', max_length=50)
    # Field name made lowercase.
    ups_warranty_status = models.CharField(
        db_column='UPS_Warranty_Status', max_length=20)
    # Field name made lowercase.
    battery_make = models.CharField(db_column='Battery_Make', max_length=50)
    # Field name made lowercase.
    battery_model_no = models.CharField(
        db_column='Battery_Model_No', max_length=50)
    # Field name made lowercase.
    battery_serial_no = models.CharField(
        db_column='Battery_Serial_No', max_length=100)
    # Field name made lowercase.
    ups_date_of_installation = models.DateField(
        db_column='UPS_Date_Of_Installation')
    # Field name made lowercase.
    battery_warranty_start_date = models.DateField(
        db_column='Battery_Warranty_Start_Date')
    # Field name made lowercase.
    battery_warranty_end_date = models.DateField(
        db_column='Battery_Warranty_End_Date')
    # Field name made lowercase.
    battery_warranty_period = models.CharField(
        db_column='Battery_Warranty_Period', max_length=50)
    # Field name made lowercase.
    battery_warranty_status = models.CharField(
        db_column='Battery_Warranty_Status', max_length=20)
    # Field name made lowercase.
    customer_name = models.ForeignKey(
        LoginCustomer, models.DO_NOTHING, db_column='Customer_Name_id')
    # Field name made lowercase.
...
class LoginUpsServiceHistory(models.Model):
    # Field name made lowercase.
    device_id = models.OneToOneField(
        'LoginUserDetail', models.DO_NOTHING, db_column='Device_ID_id', primary_key=True)
    # Field name made lowercase.
    ...
    # Field name made lowercase.
    battery_last_replaced_date = models.DateField(
        db_column='Battery_Last_Replaced_Date')
    # Field name made lowercase.
    battery_next_replacment_date = models.DateField(
        db_column='Battery_Next_Replacment_Date')
    # Field name made lowercase.
    last_service_date = models.DateField(db_column='Last_Service_Date')
    # Field name made lowercase.
    activity = models.CharField(db_column='Activity', max_length=300)

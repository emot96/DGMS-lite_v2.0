function genPDF(){
    ...
    var res = doc.autoTableHtmlToJson(document.getElementById("alertTable"));
   
    doc.addImage(imgData, 'jpeg', 270, 10, 62, 72);  
    doc.fromHTML($("#reportName").get(0), 275, 85, {'width': 250});
    doc.fromHTML($("#customerName").get(0), 20, 130, {'width': 180});
    doc.fromHTML($("#assetDetail").get(0), 20, 180, {'width': 210});
    doc.fromHTML($("#assetAddress").get(0), 380, 180, {'width': 250});
    doc.fromHTML($("#dateRange").get(0), 20,265, {'width': 180});

function genPDF(){
    ...
    doc.fromHTML($("#reportName").get(0), 225, 85, {'width': 250});
    ...
    doc.fromHTML($("#dateRange").get(0), 20,265, {'width': 280});
    doc.fromHTML($("#fuelCon").get(0), 380,265, {'width': 180});
    ...
    var options = {
        ...
        didParseCell: function (data) {
            ...
            //     data.cell.styles.fillColor = [143, 211, 112];
            //   }

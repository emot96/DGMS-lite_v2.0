function genPDF(){
    ...
    var res = doc.autoTableHtmlToJson(document.getElementById("asset-detail"));



    doc.addImage(imgData, 'jpeg', 270, 10, 62, 72); 
    doc.fromHTML($("#pdfName").get(0), 220, 85, {'width': 250});
    doc.fromHTML($("#customerName").get(0), 20, 130, {'width': 180});
    doc.fromHTML($("#assetDetail").get(0), 20, 200, {'width': 180});
    doc.fromHTML($("#assetAddress").get(0), 380, 200, {'width': 250});
    ...
    var options = {
        ...
        didParseCell: function (data) {
            ...
            if (data.row.index ===  1 || data.row.index ===  5 || data.row.index ===  10 || data.row.index ===  15 || data.row.index ===  19 || data.row.index ===  24 || data.row.index ===  29 || data.row.index ===  34) {
        ...
        startY: doc.autoTableEndPosY() + 285.8
        }; 

function genPDF(){
    ...
    var res = doc.autoTableHtmlToJson(document.getElementById("asset-detail-servo"));



    doc.addImage(imgData, 'jpeg', 270, 10, 62, 72); 
    doc.fromHTML($("#pdfName").get(0), 210, 85, {'width': 250});
    ...
    var options = {
        ...
        didParseCell: function (data) {
            ...
            if (data.row.index ===  9 || data.row.index ===  15) {
